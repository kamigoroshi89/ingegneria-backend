...
export interface ApiCweCwe extends Schema.CollectionType {
  collectionName: 'cwes';
  info: {
    singularName: 'cwe';
    pluralName: 'cwes';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::cwe.cwe', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::cwe.cwe', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiLogLog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    startEnum: Attribute.Enumeration<
      ['articolo', 'cwe', 'iso', 'mvc', 'pbd', 'strategia', 'owasp', 'pattern']
    >;
    searchEnum: Attribute.Enumeration<
      ['articolo', 'cwe', 'iso', 'mvc', 'pbd', 'strategia', 'owasp', 'pattern']
    >;
...
export interface ApiPatternPattern extends Schema.CollectionType {
  ...
  attributes: {
    ...
    articoli_gdprs: Attribute.Relation<
      ...
      'api::articoli-gdpr.articoli-gdpr'
    >;
    cwes: Attribute.Relation<
      'api::pattern.pattern',
      'manyToMany',
      'api::cwe.cwe'
    >;
    isos: Attribute.Relation<
      'api::pattern.pattern',
      'manyToMany',
      'api::iso.iso'
    >;
...
export interface ApiPbdPbd extends Schema.CollectionType {
  collectionName: 'pbds';
  info: {
    singularName: 'pbd';
    pluralName: 'pbds';
    displayName: 'Privacy By Design Principles';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::pbd.pbd', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::pbd.pbd', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
